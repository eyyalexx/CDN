...
public class HerDNSServer {
	...
	public static void main(String[] args) {
		...
		records.add(new DnsRecord("www.herCDN.com", Addresses.CDNSERVERIP, "A"));	
        ...
        try
        {
        	...
        	if(Addresses.ONEMACHINE){
        		sock = new DatagramSocket(Addresses.HERDNSPORT);
        	}else{
            ...
            while(true)
            {
                ...
                DnsQuery answerToSendBack = new DnsQuery(queryRec.getID(), 1, queryRec.getQuestion(), dnsToQuery.getVal()+";A");
